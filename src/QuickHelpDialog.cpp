...
void QuickHelpDialog::setupMouseControlsTab()
{
    ...
    QList<QStringList> rows = {
        {tr("Rotate View"), tr("Middle Button + Drag<br/>OR<br/>Ctrl + Left Button + Drag"), tr("Enable 'Rotate View' mode from toolbar")},
        {tr("Pan View"), tr("Right Button + Drag<br/>OR<br/>Ctrl + Right Button + Drag"), tr("Enable 'Pan View' mode from toolbar")},
...
void QuickHelpDialog::setupDisplayModesTab()
{
    ...
    QStringList headers = {tr("Display Mode"), tr("Description"), tr("Use Case")};
    QList<QStringList> rows = {
        {tr("Realistic"), 
...
QString QuickHelpDialog::createStyledHtml(const QString& title, const QString& content)
{
    QString html = QString(
        ...
        "code, kbd { background-color: #f4f4f4; padding: 2px 6px; border-radius: 3px; font-family: 'Courier New', monospace; }"
...
QString QuickHelpDialog::createTable(const QStringList& headers, const QList<QStringList>& rows)
{
    QString table = "<table>";
